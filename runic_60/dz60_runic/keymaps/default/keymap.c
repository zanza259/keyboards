...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    LAYOUT(
        ...
        KC_LSFT, XXXXXXX, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_MENU, KC_PSCREEN,
    ...
    LAYOUT(
        ...
        _______, _______, _______,                            _______,                   _______, KC_HOME, KC_PGUP, KC_PGDN, KC_END
    )
};
